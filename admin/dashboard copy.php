...
$subscribers_growth = array_reverse($subscribers_growth, true);
...
$posts_growth = array_reverse($posts_growth, true);
...
$newsletters_growth = array_reverse($newsletters_growth, true);
...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mt-4">
            <div class="card shadow-sm p-3">
                <h5 class="mb-3">📩 Newsletters Per Month (Last 6 months)</h5>
                <canvas id="newslettersChart" height="150"></canvas>
            </div>
        </div>
    </div>
