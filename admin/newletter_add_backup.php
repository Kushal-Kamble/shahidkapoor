...
<head>
  ...
  <!-- ✅ CKEditor 5 (Classic) -->
  <script src="https://cdn.ckeditor.com/ckeditor5/46.0.2/classic/ckeditor.js"></script>
    ...
    <div class="card-body">
      <form method="post">
        <div class="row g-3">
          ...
          <div class="col-12">
            <label class="form-label fw-semibold">Newsletter Content (CKEditor 5)</label>
...
<!-- CKEditor 5 Script (Classic + Emoji + Upload) -->
...
ClassicEditor
    .create(document.querySelector('#newsletter_content'), {
        ckfinder: {
            uploadUrl: 'http://localhost/newsletter-project-vishal/admin/upload.php'
        }
    })
    .catch(error => {
        console.error(error);
...
<script>
  // ✅ CKEditor 5 initialization with toolbar + upload + emoji
  ClassicEditor
    .create(document.querySelector('#editor'), {
      toolbar: [
        'heading','|','bold','italic','underline','link',
        'bulletedList','numberedList','blockQuote',
        'insertTable','undo','redo','imageUpload','emoji'
      ],
      ckfinder: {
        // PHP file jo image ko save karega
